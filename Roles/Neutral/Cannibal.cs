...
internal class Cannibal : RoleBase
{
    ...
    public override void SetupCustomOption()
    {
        ...
        KillCooldown = FloatOptionItem.Create(Id + 10, "CannibalKillCooldown", new(0f, 180f, 2.5f), 30f, TabGroup.NeutralRoles, false).SetParent(Options.CustomRoleSpawnChances[CustomRoles.Pelican])
    ...
    public static Vector2 GetBlackRoomPSForCannibal()
    {
    ...
    public override string GetProgressText(byte playerId, bool coooms)
    {
        ...
        return Utils.ColorString(eatenNum < 1 ? Color.gray : Utils.GetRoleColor(CustomRoles.Cannibal), $"({eatenNum})");
    }
    private void EatPlayer(PlayerControl pc, PlayerControl target)
    {
        ...
        target.RpcTeleport(GetBlackRoomPSForCannibal());
    ...
    public override bool OnCheckMurderAsKiller(PlayerControl killer, PlayerControl target)
    {
        ...
        {
            killer.SetKillCooldown();
            killer.Notify(GetString("Cannibal.TargetCannotBeEaten"));
        }
        return false;
    }
